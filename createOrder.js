...
module.exports.handler = async (event) => {
    ...
    const params = {
        ...
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/015505579413/order-queue' // Reemplaza con tu URL de la cola
    };
    ...
    try {
        ...
        const emailParams = {
            Destination: {
                ToAddresses: ['mariaeugeniadiazzapata6@gmail.com'] // Reemplaza con la dirección de correo electrónico del cliente
            },
            Message: {
                Body: {
                    Text: {
            ...
            Source: 'tavo9829@gmail.com' // Reemplaza con tu dirección de correo electrónico
        };
